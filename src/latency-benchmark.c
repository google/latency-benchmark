...
bool update_statistic(statistic *stat, int value, int64_t screenshot_time,
...
static void report_latency(struct mg_connection *connection,
  ...
  if (!measure_latency(magic_pattern, &key_down_latency_ms, &scroll_latency_ms, &max_js_pause_time_ms, &max_css_pause_time_ms, &max_scroll_pause_time_ms, &error)) {
